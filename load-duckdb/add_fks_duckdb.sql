-- DuckDB foreign key constraints for IMDB dataset (JOB benchmark)
-- Converted from PostgreSQL add_fks.sql

ALTER TABLE title ADD FOREIGN KEY (kind_id) REFERENCES kind_type;
ALTER TABLE aka_name ADD FOREIGN KEY (id) REFERENCES name;
-- Note: Commented out problematic FK constraint from original PostgreSQL version
